                    ...
                    <div class="col-md-12">
                        ...
                        <div class="table-data__tool">
                            ...
                            <div class="table-data__tool-right">
                                <button class="au-btn au-btn-icon btn-success au-btn--small">
                                ...
                                <button class="au-btn au-btn-icon btn-warning au-btn--small" data-toggle="modal" data-target="#modalFilter">
                                    <i class="zmdi zmdi-eye"></i>Filter Tanggal</button>
                                <button class="au-btn au-btn-icon btn-info au-btn--small" data-toggle="modal" data-target="#modalCetak">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="table-data-feature ">
                                                        <a class="item bg-primary mx-auto" href="/transaksi/up_status/{{ $transaksi->id  }}">
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        <a class="item bg-info mx-auto" href="/transaksi/print/{{  $transaksi->id}}">
                            ...
                            <div class="card-body card-block">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="tanggal_awal" class="form-control datepicker" id="date"  placeholder="MM/DD/YYYY" type="text" value="{{ date('m-d-Y') }}" autocomplete="off"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="tanggal_akhir" class="form-control datepicker" id="date"  placeholder="MM/DD/YYYY" type="text" value="{{ date('m-d-Y') }}" autocomplete="off"/>
                                    </div>
                                </div>
     ...
     <div class="modal" id="modalCetak" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        <h2 class="title-1"><strong>Cetak </strong> Laporan</h2>
                    </h5>
                    <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="card-body card-block">
                        <form action="/transaksi/cetakLaporan" method="POST" class="form-horizontal">
                        {{ csrf_field() }}
                            <div class="card-body card-block">
                                <div class="form-group">
                                    <label for="vat" class=" form-control-label " >Tanggal awal</label>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <a href="/transaksi/cetakLaporanSemua" class="btn btn-info">Cetak Semua</a>
                                <button type="submit" class="btn btn-warning">Cetak Per Tanggal</button>
                            </div>
                        </form>
