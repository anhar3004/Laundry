                    ...
                    <div class="col-lg-12">
                        <div class="col-md-12">
                            <div class="overview-wrap">
                                <h2 class="title-1 fw-bold">Paket Laundry</h2>
                            </div>
                                    ...
                                    @foreach ($data_paket as $paket)
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{{ $paket->jenis_layanans->jenis_layanan }}</td>
                                                <td>{{ $paket->paket }}</td>
                                                <td>{{ $paket->berat }} Kg</td>
                                                <td>Rp. {{ number_format($paket->tarif) }}</td>
                                                <td>
                                                    <div class="table-data-feature">
                                                        <a class="item bg-warning" href="/paket/{{ $paket->id }}/edit">
                                                            <i class="zmdi zmdi-edit text-white"></i>
                                                        </a>
                                                        <a class="item bg-danger" href="/paket/{{ $paket->id }}/delete" onclick="return confirm('apakah yakin akan di hapus ?')">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        <h2 class="title-1"><strong>Tambah</strong> Produk</h2>
                    </h5>
                    <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="card-body card-block">
                        <form action="paket/tambah" method="post" class="form-horizontal">
                            {{ csrf_field() }}
                            <div class="card-body card-block">
                                <div class="form-group">
                                    <label for="vat" class=" form-control-label">Kode Paket</label>
                                    <input name="kode_paket" type="text" id="vat" placeholder="" class="form-control" value="{{ $noUrutAkhir }} " readonly>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="disabledSelect" class="form-select" name="jenis_layanan">
                                        ...
                                        <option value="{{ $jenis->id }}">{{ $jenis->jenis_layanan }}</option>
                                        @endforeach
                                      </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="paket" type="text" id="vat" placeholder="" class="form-control">
                                </div>
                                <div class="form-group">
